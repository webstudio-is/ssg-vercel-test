const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/entries/pages_another-page.CV8AgmjB.js",
      "assets/chunks/chunk-DR8ib49y.js",
      "assets/static/index.CKPgriBt.css",
      "assets/entries/pages_index.DBvE1uiq.js",
    ])
) => i.map((i) => d[i]);
function ye(e) {
  ...
  Qt = [
    {
      ...
      loadConfigValuesAll: () =>
        ue(
          () => import("./pages_another-page.CV8AgmjB.js"),
    ...
    },
    {
      ...
      loadConfigValuesAll: () =>
        ue(
          () => import("./pages_index.DBvE1uiq.js"),
